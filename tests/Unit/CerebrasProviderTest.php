...
class CerebrasProviderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->provider = new CerebrasProvider($this->config);
    }

    public function test_provider_name_is_cerebras(): void
    {
        $this->assertEquals('cerebras', $this->provider->getName());
    }
    ...
    public function test_provider_is_not_configured_without_api_key(): void
    {
        ...
        $provider = new CerebrasProvider($configWithoutKey);
    ...
    public function test_handles_string_to_array_conversion(): void
    {
        ...
        // Notes now include service info as first element
        $notes = $response->getNotes();
        $this->assertCount(2, $notes);
        $this->assertStringContainsString('Generated by: cerebras', $notes[0]);
        $this->assertEquals('Single note string', $notes[1]);
